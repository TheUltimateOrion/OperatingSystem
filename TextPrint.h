...
const char* FloatToString(uint_8 value);
const char* FloatToString(uint_16 value);
const char* FloatToString(uint_32 value);
const char* FloatToString(uint_64 value);
