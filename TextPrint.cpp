...
const char* FloatToString(uint_8 value) { return FloatToString(value); }
const char* FloatToString(uint_16 value) { return FloatToString(value); }
const char* FloatToString(uint_32 value) { return FloatToString(value); }
const char* FloatToString(uint_64 value) { return FloatToString(value); }
